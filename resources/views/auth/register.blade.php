                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="email" type="email"
                                           class="rounded-0 w-100 input-area gray-bg @error('email') is-invalid @enderror" name="email"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="password" type="password"
                                           class="rounded-0 w-100 input-area gray-bg @error('password') is-invalid @enderror" name="password"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="rounded-0 w-100 input-area gray-bg"
