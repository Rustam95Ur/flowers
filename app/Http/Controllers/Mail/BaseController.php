...
class BaseController extends Controller
{
    ...
    public static function payment_send_mail($request_data, $total_price, $products): bool
    {
        ...
        $requestForm->add_photo = $request_data['photo'];
        $requestForm->surprise = $request_data['surprise'];
        $requestForm->total = $total_price;
        $requestForm->products = $products;
        $requestForm->currency = $request_data['currency'];
        $requestForm->currency_value = $request_data['currency_value'];
     ...
     * @return RedirectResponse
     */
    public function calculator_send(Request $request): RedirectResponse
    {
