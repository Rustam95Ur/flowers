var inputWithPlaceholderHelper, entranceCheckModalHelper, entranceCheckModal;
inputWithPlaceholderHelper || (inputWithPlaceholderHelper = {});
inputWithPlaceholderHelper.init = function () {
    var n = this;
    n.$inputs = $("input[data-type=inputWithPlaceholder]");
    n.setDefault();
    n.bindPlaceholders();
    n.bindSubmit()
};
inputWithPlaceholderHelper.setDefault = function () {
    var n = this;
    n.$inputs.each(function () {
        var n = $(this);
        n.attr("data-empty", !n.val())
    })
};
inputWithPlaceholderHelper.bindPlaceholders = function (n) {
    var t = this;
    n = n || t.$inputs;
    n.off("blur.inputWithPlaceholderHelper change.inputWithPlaceholderHelper").on("blur.inputWithPlaceholderHelper change.inputWithPlaceholderHelper", function () {
        var n = $(this);
        n.attr("data-empty", !n.val())
    })
};
inputWithPlaceholderHelper.bindSubmit = function () {
    var n = this;
    n.$inputs.each(function () {
        var t = $(this);
        t.closest("form").off("submit.inputWithPlaceholderHelper").on("submit.inputWithPlaceholderHelper", function () {
            var t = $(this);
            setTimeout(function () {
                t.find(n.$inputs).each(function () {
                    var n = $(this);
                    n.val() || n.val("")
                })
            }, 4)
...
$(function () {
    inputWithPlaceholderHelper.init()
});
entranceCheckModalHelper = {};
entranceCheckModalHelper.init = function () {
    var n = this;
    n.$body = $("body");
    entranceCheckModalHelper.defaultModal()
};
entranceCheckModalHelper.defaultModal = function () {
    var t = this, n;
    $(".entranceCheckModal__overflow--active").length && (n = new entranceCheckModal($(".entranceCheckModal__overflow--active").first()), n.show())
};
$(function () {
    entranceCheckModalHelper.init()
});
entranceCheckModal || (entranceCheckModal = function (n) {
    this.init = function () {
        var t = this;
        t.$wrapper = $(n);
        t.$body = $("body");
    ...
    this.bindHideMessage = function () {
        var n = this;
        $(".entranceCheckModal__close", n.$wrapper).add(".entranceCheckModal__buttonClose", n.$wrapper).on("click.entranceCheckModal", function () {
            n.hide()
        })
    };
    this.show = function () {
        ...
        n.$wrapper.appendTo(n.$body).fadeIn(200, function () {
            n.$wrapper.addClass("entranceCheckModal__overflow--active");
            n.$body.addClass("body--blurred body--noscroll");
            n.$html.addClass("ntml--noscroll")
        })
    };
    this.hide = function () {
        var n = this;
        n.$body.removeClass("body--blurred body--noscroll");
        n.$html.removeClass("ntml--noscroll");
        n.$wrapper.fadeOut(200, function () {
            n.$wrapper.removeClass("entranceCheckModal__overflow--active")
        })
    };
    this.init()
});
typeof SMSHelper == "undefined" && (SMSHelper = {});
SMSHelper.init = function () {
    var n = this;
    (n.$wrapper = $("#SMSCodeFormCommon")).length && (n.$form = $("form#SMSCodeFormCommon"), n.$body = $("body"), n.timerCount = 59, n.timer = 0, n.smsCount = 0, n.smsData = "", n.isStartedReadingSms = !1, n.inputs = {
        $txtOtp: $("#txtOtp", n.$wrapper),
        $txtOtps: $(".commonModalSMS__input", n.$wrapper),
        $txtOtpChar1: $("#txtOtpChar1", n.$wrapper),
        $txtOtpChar2: $("#txtOtpChar2", n.$wrapper),
        $txtOtpChar3: $("#txtOtpChar3", n.$wrapper),
        $txtOtpChar4: $("#txtOtpChar4", n.$wrapper),
        $otpCodeName: $("#otpCodeName", n.$wrapper)
    }, n.el = {
        $timerText: $(".commonModalSMS__timerText"),
        $timer: $(".commonModalSMS__timer"),
        $buttonResend: $(".commonModalSMS__buttonResend"),
        $buttonSend: $(".commonModal__buttonContinue")
    }, n.autoSendWhenCompleteDesktop = !0, n.autoSendWhenCompleteMobile = !0, n.setStartValues(), n.bindInputs(), n.bindButtonResend(), n.bindOnSubmit(), n.bindSubmit(), n.bindSMSModalHelperError(), n.bindHideMessage())
};
SMSHelper.showForm = function (n) {
    var t = this, i = new commonModal($("#SMSCodeFormCommon"));
    i.show();
    $("body").unmask();
    t.sendEntranceOtp(n);
    t.inputs.$txtOtpChar1.click().focus()
};
SMSHelper.setStartValues = function () {
    var n = this;
    n.el.$timer.html(59)
};
SMSHelper.sendEntranceOtp = function (n) {
    var t = this, i;
    t.timer == 0 && (i = t.$form.length > 0 ? "/SendEntranceOtp" : "/transfers/transfer/SendOtp", $.ajax({
        url: i,
        data: n,
        type: "POST",
        dataType: "json",
        ...
        t.smsCount > 3 && (t.timerCount = 119);
        t.timer = t.timerCount;
        t.startTimer();
        t.smsCount++;
        $.cookie("is_mobile_app") == "true" && window.mobapp && typeof window.mobapp.startReadingSms == "function" && !t.isStartedReadingSms && (window.mobapp.startReadingSms(t.timerCount, "SMSHelper.onSmsCodeReceived"), t.isStartedReadingSms = !0, console.log("StartedReadingSms"))
    }).fail(function (n, t) {
        console.log("Request failed: " + t)
    }))
};
SMSHelper.checkBankOtp = function () {
    var n = this;
    $.ajax({
        url: "/bank/CheckBankOtp",
        data: {
            otpCodeName: n.inputs.$otpCodeName.val(),
            otp: n.inputs.$txtOtpChar1.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar2.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar3.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar4.inputmask("unmaskedvalue")
        },
        type: "POST",
        dataType: "json",
        beforeSend: function () {
        ...
        success: function (t) {
            $.isEmptyObject(t) || t.status != "OK" ? n.$SMSModalHelperError && (n.$SMSModalHelperError.find(".commonAlert__text").html(t.messageText ? t.messageText : ""), n.$SMSModalHelperError.find(".commonAlert__title").html(t.messageTitle ? t.messageTitle : ""), n.SMSModalHelperError.show(), n.$wrapper.find("[id^=txtOtpChar]").val("").removeClass("commonModalSMS__input--hasValue"), $("body").unmask(), digitalData = digitalData || {}, digitalData.events = digitalData.events || [], digitalData.events.push({
                name: "Transfer Validation Error Occurred",
                category: "Transfers Validation Errors",
                action: window.digitalData.page.category || "",
                label: "SmsCode - " + (t.messageText ? t.messageText : "") + (t.messageTitle ? t.messageTitle : "")
            }), console.log(t)) : $("#" + n.el.$buttonSend.data("form")).append(n.inputs.$txtOtp).trigger("submit")
        }
    })
};
SMSHelper.bindInputs = function () {
    var n = this;
    $(".commonModalSMS__input", n.$wrapper).keydown(function (t) {
        t = t || window.event;
        var i = $(this), u = t.which || t.keyCode || t.charCode, r = t.target.selectionStart, f = t.target.value.length;
        switch (u) {
            case 8:
                i.val() ? i.val("") : (i.removeClass("commonModalSMS__input--hasValue"), n.setFocusToPrevInput(i));
                break;
            case 46:
                i.val() ? i.val("") : (i.removeClass("commonModalSMS__input--hasValue"), n.setFocusToNextInput(i));
                break;
            case 37:
                r == 0 && n.setFocusToPrevInput(i);
                break;
            case 39:
                r == f && n.setFocusToNextInput(i)
        }
    }).keyup(function (t) {
        t = t || window.event;
        var i = $(this), r = t.which || t.keyCode || t.charCode, u = t.target.selectionStart, f = t.target.value.length,
            e = String.fromCharCode(r);
        /[0-9]/.test(this.value) ? this.value.length == this.maxLength && n.setFocusToNextInput(i) : this.value = "";
        (n.autoSendWhenCompleteDesktop && deviceType !== "Mobile" || n.autoSendWhenCompleteMobile && deviceType == "Mobile") && n.inputs.$txtOtpChar4.attr("id") == this.id && n.inputs.$txtOtp.val().length == 4 && (n.checkBankOtp(), i.blur())
    }).keypress(function (n) {
        n = n || window.event;
        var u = $(this), i = n.which || n.keyCode || n.charCode, f = n.target.selectionStart, e = n.target.value.length,
            t = String.fromCharCode(i), r = /[0-9]/;
        return !r.test(t) && i > 47 ? (n.returnValue = !1, n.preventDefault && n.preventDefault(), !1) : (r.test(t) && u.val(t).change(), !0)
    }).on("focus.SMSHelper", function () {
        var t = $(this), i = t.prev(".commonModalSMS__input");
        t.val() || !i.length || i.val() || n.setFocusToPrevInput(t)
    }).on("change.SMSHelper input.SMSHelper", function () {
        var t = $(this);
        t.val().length > 0 && t.addClass("commonModalSMS__input--hasValue");
        n.setLogin()
    })
};
SMSHelper.setFocusToPrevInput = function (n) {
    var i = this, t = n.prev(".commonModalSMS__input");
    return t.length ? (t.click().focus(), !0) : !1
};
SMSHelper.setFocusToNextInput = function (n) {
    var i = this, t;
    return (t = n.next(".commonModalSMS__input"), t.length) ? (t.click().focus(), !0) : !1
};
SMSHelper.startTimer = function () {
    var n = this, t = setInterval(function () {
        n.timer--;
        n.el.$timer.html(n.timer);
        n.timer == 0 && (clearInterval(t), n.showButtonResend())
    }, 1e3)
};
SMSHelper.showButtonResend = function () {
    var n = this;
    n.el.$buttonResend.css("display", "inline-block");
    n.el.$timerText.hide()
};
SMSHelper.hideButtonResend = function () {
    var n = this;
    n.el.$buttonResend.hide();
    n.el.$timerText.show()
};
SMSHelper.bindButtonResend = function () {
    var n = this;
    n.el.$buttonResend.off("click.SMSHelper").on("click.SMSHelper", function () {
        n.timer == 0 && (n.sendEntranceOtp(n.smsData), n.hideButtonResend())
    })
};
SMSHelper.setLogin = function () {
    var n = this;
    n.inputs.$txtOtp.val(n.inputs.$txtOtpChar1.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar2.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar3.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar4.inputmask("unmaskedvalue"))
};
SMSHelper.bindOnSubmit = function () {
    var n = this;
    n.$wrapper.off("submit.beginHelper").on("submit.beginHelper", function () {
        n.setLogin()
    })
};
SMSHelper.bindSubmit = function () {
    var n = this;
    n.el.$buttonSend.off("click.registerSMSValidationHelper").on("click.registerSMSValidationHelper", function () {
        n.checkBankOtp()
    })
};
SMSHelper.bindSMSModalHelperError = function () {
    var n = this;
    typeof commonAlert == "function" && (n.$SMSModalHelperError = $("#SMSModalHelperError"), n.SMSModalHelperError = new commonAlert(n.$SMSModalHelperError))
};
SMSHelper.onSmsCodeReceived = function (n) {
    var i = this, t;
    if (typeof n != "undefined" && n) {
        if (typeof n != "string" && (n = n.toString()), n.length != 4) return;
        for ($.cookie("is_mobile_app") == "true" && window.mobapp && typeof window.mobapp.stopReadingSms == "function" && (window.mobapp.stopReadingSms(), i.isStartedReadingSms = !1), i.inputs.$txtOtp.val(n), t = 0; t < 4; t++) $("#txtOtpChar" + (t + 1), i.$wrapper).val(n.charAt(t));
        i.checkBankOtp()
    }
};
SMSHelper.bindHideMessage = function () {
    var n = this;
    $(".commonModal__close", n.$wrapper).off("click.SMSHelper").on("click.SMSHelper", function () {
        $.cookie("is_mobile_app") == "true" && window.mobapp && typeof window.mobapp.stopReadingSms == "function" && (window.mobapp.stopReadingSms(), n.isStartedReadingSms = !1)
    })
};
$(function () {
    SMSHelper.init()
});
typeof commonSMSModalHelper == "undefined" && (commonSMSModalHelper = {});
commonSMSModalHelper.init = function () {
    var n = this;
    (n.$wrapper = $("#SMSCodeForm")).length && (n.$body = $("body"), n.timerCount = 59, n.timer = 0, n.smsCount = 0, n.isStartedReadingSms = !1, $('input[name="OtpAppName"]').length > 0 && (n.appName = $('input[name="OtpAppName"]')), $('input[name="OtpAmount"]').length > 0 && $('input[name="OtpAmount"]').val() != null && (n.amount = $('input[name="OtpAmount"]').val()), n.sendOtpUrl = $('input[name="SendOtpUrl"]').length > 0 && $('input[name="SendOtpUrl"]').val() != null ? $('input[name="SendOtpUrl"]').val() : "/bank/SendBankOtp", n.checkOtpUrl = $('input[name="CheckOtpUrl"]').length > 0 && $('input[name="CheckOtpUrl"]').val() != null ? $('input[name="CheckOtpUrl"]').val() : "/bank/CheckBankOtp", n.inputs = {
        $txtOtp: $("#txtOtp", n.$wrapper),
        $txtOtps: $(".commonModalSMS__input", n.$wrapper),
        $txtOtpChar1: $("#txtOtpChar1", n.$wrapper),
        $txtOtpChar2: $("#txtOtpChar2", n.$wrapper),
        ...
        $timer: $(".commonModalSMS__timer"),
        $buttonResend: $(".commonModalSMS__buttonResend"),
        $buttonSend: $("#SMSCodeButton")
    }, n.autoSendWhenCompleteDesktop = !0, n.autoSendWhenCompleteMobile = !0, n.setStartValues(), n.sendOtp(), n.bindInputs(), n.bindButtonResend(), n.bindOnSubmit(), n.bindSubmit(), n.bindSMSModalHelperError(), n.bindHideMessage(), setTimeout(function () {
        n.inputs.$txtOtpChar1.click().focus()
    }, 100))
};
commonSMSModalHelper.setStartValues = function () {
    var n = this;
    n.el.$timer.html(59)
};
commonSMSModalHelper.sendOtp = function () {
    var n = this, t;
    n.timer == 0 && (t = {}, typeof n.appName != "undefined" && n.appName.val() && (t.otpCodeName = n.appName.val()), typeof n.amount != "undefined" && (t.amount = n.amount), $.ajax({
        url: n.sendOtpUrl,
        data: t,
        type: "POST",
        dataType: "json",
        ...
        n.smsCount > 3 && (n.timerCount = 119);
        n.timer = n.timerCount;
        n.startTimer();
        n.smsCount++;
        $.cookie("is_mobile_app") == "true" && window.mobapp && typeof window.mobapp.startReadingSms == "function" && !n.isStartedReadingSms && (window.mobapp.startReadingSms(n.timerCount, "commonSMSModalHelper.onSmsCodeReceived"), n.isStartedReadingSms = !0)
    }))
};
commonSMSModalHelper.checkOtp = function () {
    var n = this, t = {};
    t.otp = n.inputs.$txtOtpChar1.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar2.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar3.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar4.inputmask("unmaskedvalue");
    typeof n.appName != "undefined" && n.appName.val() && (t.otpCodeName = n.appName.val());
    $.ajax({
        url: n.checkOtpUrl, data: t, type: "POST", dataType: "json", beforeSend: function () {
            $("body").mask(!0)
        }, success: function (t) {
            $.isEmptyObject(t) || t.status != "OK" ? n.$SMSModalHelperError && (n.$SMSModalHelperError.find(".commonAlert__text").html(t.messageText ? t.messageText : ""), n.$SMSModalHelperError.find(".commonAlert__title").html(t.messageTitle ? t.messageTitle : ""), n.SMSModalHelperError.show(), n.$wrapper.find("[id^=txtOtpChar]").val("").removeClass("commonModalSMS__input--hasValue"), $("body").unmask(), typeof baseHelper != "undefined" && baseHelper.addEventToDDL("Form Validation Errors", "Validation Error Occurred", n.inputs.$txtOtp.attr("name") + " - " + t.messageTitle + " " + t.messageText, typeof window.digitalData.page.signupStep == "undefined" ? window.digitalData.page.type : window.digitalData.page.type + " - " + window.digitalData.page.signupStep)) : n.$wrapper.submit()
        }
    })
};
commonSMSModalHelper.bindInputs = function () {
    var n = this;
    $(".commonModalSMS__input", n.$wrapper).keydown(function (t) {
        t = t || window.event;
        var i = $(this), u = t.which || t.keyCode || t.charCode, r = t.target.selectionStart, f = t.target.value.length;
        ...
        var i = $(this), r = t.which || t.keyCode || t.charCode, u = t.target.selectionStart, f = t.target.value.length,
            e = String.fromCharCode(r);
        /[0-9]/.test(this.value) ? this.value.length == this.maxLength && n.setFocusToNextInput(i) : this.value = "";
        (n.autoSendWhenCompleteDesktop && deviceType !== "Mobile" || n.autoSendWhenCompleteMobile && deviceType == "Mobile") && n.inputs.$txtOtpChar4.attr("id") == this.id && n.inputs.$txtOtp.val().length == 4 && (n.checkOtp(), i.blur())
    }).keypress(function (n) {
        n = n || window.event;
        var u = $(this), i = n.which || n.keyCode || n.charCode, f = n.target.selectionStart, e = n.target.value.length,
            t = String.fromCharCode(i), r = /[0-9]/;
        return !r.test(t) && i > 47 ? (n.returnValue = !1, n.preventDefault && n.preventDefault(), !1) : (r.test(t) && u.val(t).change(), !0)
    }).on("focus.commonSMSModalHelper", function () {
        var t = $(this), i = t.prev(".commonModalSMS__input");
        t.val() || !i.length || i.val() || n.setFocusToPrevInput(t)
    }).on("change.commonSMSModalHelper input.commonSMSModalHelper", function () {
        var t = $(this);
        t.val().length > 0 && t.addClass("commonModalSMS__input--hasValue");
        n.setLogin()
    })
};
commonSMSModalHelper.setFocusToPrevInput = function (n) {
    var i = this, t = n.prev(".commonModalSMS__input");
    return t.length ? (t.click().focus(), !0) : !1
};
commonSMSModalHelper.setFocusToNextInput = function (n) {
    var i = this, t;
    return (t = n.next(".commonModalSMS__input"), t.length) ? (t.click().focus(), !0) : !1
};
commonSMSModalHelper.startTimer = function () {
    var n = this, t = setInterval(function () {
        n.timer--;
        n.el.$timer.html(n.timer);
        n.timer == 0 && (clearInterval(t), n.showButtonResend())
...
commonSMSModalHelper.showButtonResend = function () {
    var n = this;
    n.el.$buttonResend.css("display", "inline-block");
    n.el.$timerText.hide()
};
commonSMSModalHelper.hideButtonResend = function () {
    var n = this;
    n.el.$buttonResend.hide();
    n.el.$timerText.show()
};
commonSMSModalHelper.bindButtonResend = function () {
    var n = this;
    n.el.$buttonResend.off("click.commonSMSModalHelper").on("click.commonSMSModalHelper", function () {
        n.timer == 0 && (n.sendOtp(), n.hideButtonResend())
    })
};
commonSMSModalHelper.setLogin = function () {
    var n = this;
    n.inputs.$txtOtp.val(n.inputs.$txtOtpChar1.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar2.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar3.inputmask("unmaskedvalue") + n.inputs.$txtOtpChar4.inputmask("unmaskedvalue"))
};
commonSMSModalHelper.bindOnSubmit = function () {
    var n = this;
    n.$wrapper.off("submit.beginHelper").on("submit.beginHelper", function () {
        n.setLogin()
    })
};
commonSMSModalHelper.bindSubmit = function () {
    var n = this;
    n.el.$buttonSend.off("click.commonSMSModalHelper").on("click.commonSMSModalHelper", function () {
        n.checkOtp()
    })
};
commonSMSModalHelper.bindSMSModalHelperError = function () {
    var n = this;
    typeof commonAlert == "function" && (n.$SMSModalHelperError = $("#SMSModalHelperError"), n.SMSModalHelperError = new commonAlert(n.$SMSModalHelperError))
};
commonSMSModalHelper.onSmsCodeReceived = function (n) {
    var i = this, t;
    if (typeof n != "undefined" && n) {
        if (typeof n != "string" && (n = n.toString()), n.length != 4) return;
        for ($.cookie("is_mobile_app") == "true" && window.mobapp && typeof window.mobapp.stopReadingSms == "function" && (window.mobapp.stopReadingSms(), i.isStartedReadingSms = !1), i.inputs.$txtOtp.val(n), t = 0; t < 4; t++) $("#txtOtpChar" + (t + 1), i.$wrapper).val(n.charAt(t));
...
commonSMSModalHelper.bindHideMessage = function () {
    var n = this;
    $(".commonModal__close", n.$wrapper).off("click.commonSMSModalHelper").on("click.commonSMSModalHelper", function () {
        $.cookie("is_mobile_app") == "true" && window.mobapp && typeof window.mobapp.stopReadingSms == "function" && (window.mobapp.stopReadingSms(), n.isStartedReadingSms = !1)
    })
};
$(function () {
    commonSMSModalHelper.init()
});
typeof tabsHelper == "undefined" && (tabsHelper = {});
tabsHelper.init = function () {
    var n = this
};
$(function () {
    tabsHelper.init()
...
typeof entranceHelper == "undefined" && (entranceHelper = {});
entranceHelper.init = function () {
    var n = this;
    (n.$wrapper = $(".entrance__form")).length && (n.inputs = {
        $txtLogin: $(".txtLogin", n.$wrapper),
        $txtPassword: $("#txtPassword", n.$wrapper)
    }, n.$restorePasswordLink = $("#RestorePasswordLink"), n.$restorePasswordButton = $("#RestorePasswordButton"), n.defaultPasswordRecoveryLink = n.$restorePasswordLink.attr("href"), n.incompleteSignin = !0, n.inputs.$txtLogin.inputmask("unmaskedvalue").length > 0 && entranceHelper.slicePhoneNumberLenth(), entranceHelper.bindRestorePasswordModal(), entranceHelper.bindInputmask(), entranceHelper.bindHidePasswordInputError(), entranceHelper.bindHideLoginInputError(), entranceHelper.bindOnSubmit(), entranceHelper.bindOnunload(), entranceHelper.bindOnSignin(), entranceHelper.bindOnRefresh(), entranceHelper.bindRestorePasswordLink())
};
entranceHelper.bindRestorePasswordModal = function () {
    if (typeof commonModal == "function") {
        var t = this, n = new commonModal("#RestorePasswordModal");
        $("#RestorePasswordModalOpener").off("click.entranceHelper").on("click.entranceHelper", function () {
            n.show()
        })
    }
};
entranceHelper.bindInputmask = function () {
    var n = this;
    n.inputs.$txtLogin.inputmask("+7 (999) 999-99-99", {
        placeholder: "•",
        showMaskOnHover: !1,
        ...
        onKeyDown: function (t) {
            ...
            i != 13 || n.inputs.$txtPassword.val() || (t.preventDefault(), n.setFocusToInput(n.inputs.$txtPassword))
        }
    })
};
entranceHelper.slicePhoneNumberLenth = function () {
    var t = this, n = t.inputs.$txtLogin.inputmask("unmaskedvalue"), i;
    n && n.length > 10 && (i = n.slice(n.length - 10), t.inputs.$txtLogin.val(i))
};
entranceHelper.bindOnSubmit = function () {
    var n = this;
    n.$wrapper.off("submit.entranceHelper").on("submit.entranceHelper", function () {
        var t = n.checkInputFields(n.inputs);
        return t ? (typeof inputHelper != "undefined" && typeof deviceType != "undefined" && deviceType == "Desktop" && inputHelper.showLoaderIcon(), !0) : !1
    })
};
entranceHelper.checkInputFields = function (n) {
    var r = n.$txtLogin.inputmask("unmaskedvalue"), u = n.$txtPassword.val(), i = !0, t, f;
    return !r || r.length < 10 ? (t = n.$txtLogin.data("text"), n.$txtLogin.hasClass("entrance__input--error") || n.$txtLogin.addClass("entrance__input--error"), $(".entrance__inputErrorMessage") && $(".entrance__inputErrorMessage").length > 0 ? $(".entrance__inputErrorMessage").hasClass("entrance__inputErrorMessage--active") ? $(".entrance__inputErrorMessage--active").html(t) : $(".entrance__inputErrorMessage").addClass("entrance__inputErrorMessage--active").html(t) : $("#EmptyAlertWindow") && $("#EmptyAlertWindow").length > 0 && (f = new commonModal("#EmptyAlertWindow"), $(".commonAlert__title").html(t), f.show()), typeof baseHelper != "undefined" && baseHelper.addEventToDDL("Form Validation Errors", "Validation Error Occurred", "Login - " + t, typeof window.digitalData.page.signupStep == "undefined" ? window.digitalData.page.type : window.digitalData.page.type + " - " + window.digitalData.page.signupStep), i = !1) : $(".entrance__inputErrorMessage").hasClass("entrance__inputErrorMessage--active") && $(".entrance__inputErrorMessage").removeClass("entrance__inputErrorMessage--active").html(""), u && u.length != 0 || (n.$txtPassword.hasClass("entrance__input--error") || n.$txtPassword.addClass("entrance__input--error"), typeof baseHelper != "undefined" && baseHelper.addEventToDDL("Form Validation Errors", "Validation Error Occurred", "Password - Поле не заполнено", typeof window.digitalData.page.signupStep == "undefined" ? window.digitalData.page.type : window.digitalData.page.type + " - " + window.digitalData.page.signupStep), i = !1), i
};
entranceHelper.setFocusToInput = function (n) {
    var t = this;
    n.focus()
};
entranceHelper.bindHideLoginInputError = function () {
    var n = this;
    n.inputs.$txtLogin.off("input.bindHideLoginInputError change.bindHideLoginInputError").on("input.bindHideLoginInputError change.bindHideLoginInputError", function () {
        n.inputs.$txtLogin.hasClass("entrance__input--error") && n.inputs.$txtLogin.removeClass("entrance__input--error")
    })
};
entranceHelper.bindHidePasswordInputError = function () {
    var n = this;
    n.inputs.$txtPassword.off("input.bindHidePasswordInputError change.bindHidePasswordInputError").on("input.bindHidePasswordInputError change.bindHidePasswordInputError", function () {
        n.inputs.$txtPassword.hasClass("entrance__input--error") && n.inputs.$txtPassword.removeClass("entrance__input--error")
    })
};
entranceHelper.bindOnunload = function () {
    var n = this;
    window.addEventListener("unload", function () {
        n.incompleteSignin == !0 && $.ajax({
            url: "/IncompleteSignIn", type: "GET", success: function () {
            }
        }).always(function () {
        }).fail(function () {
        })
...
entranceHelper.bindOnSignin = function () {
    var n = this;
    $("input[type=submit]").bind("click", function () {
        n.incompleteSignin = !1
    })
};
entranceHelper.bindOnRefresh = function () {
    var n = this;
    window.addEventListener("keydown", function (t) {
        var i = t.which || t.keyCode;
        i == 116 && (n.incompleteSignin = !1)
    })
};
entranceHelper.bindRestorePasswordLink = function () {
    var n = this;
    if (n.$restorePasswordLink.length) {
        n.setRestorePasswordLink(n.$restorePasswordLink.attr("id"));
        n.inputs.$txtLogin.on("input.bindRestorePasswordLink", function () {
            n.setRestorePasswordLink(n.$restorePasswordLink.attr("id"))
        })
    }
    if (n.$restorePasswordButton.length) {
        n.setRestorePasswordLink(n.$restorePasswordButton.attr("id"));
        n.inputs.$txtLogin.on("input.bindRestorePasswordLink", function () {
            n.setRestorePasswordLink(n.$restorePasswordButton.attr("id"))
        })
    }
};
entranceHelper.setRestorePasswordLink = function (n) {
    if ($("#" + n).length) {
        var t = this, i = t.inputs.$txtLogin.inputmask("unmaskedvalue");
        i && i.length === 10 && t.defaultPasswordRecoveryLink ? $("#" + n).attr("href", t.defaultPasswordRecoveryLink + "?login=" + i) : $("#" + n).attr("href", t.defaultPasswordRecoveryLink)
    }
};
$(function () {
    entranceHelper.init()
