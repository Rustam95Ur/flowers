(function ($) {
    ...
    $('.qtybutton').on('click', function () {
        ...
        updated_after_delete(product_id, newVal)
    });
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(event.strftime('<div class="single-countdown"><span class="single-countdown_time">%D</span>' +
                '<span class="single-countdown_text">дня</span></div><div class="single-countdown"><span class="single-countdown_time">%H</span>' +
                '<span class="single-countdown_text">часов</span></div><div class="single-countdown"><span class="single-countdown_time">%M</span>' +
                '<span class="single-countdown_text">минут</span></div><div class="single-countdown"><span class="single-countdown_time">%S</span>' +
                '<span class="single-countdown_text">секунд</span></div>'));
        });
    });
    /*----------------------------------------*/
    /*------ Popup Image
